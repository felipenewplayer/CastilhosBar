...
export const Banner = () => {
    return (
        <div className="bg-black p-4 sm:p-6 md:p-10 lg:p-15 xl:p-20 flex flex-col lg:flex-row xl:flex-row justify-between items-center border-b border-gray-500/50 mb-10">
            <div className="flex flex-col lg:flex-row xl:flex-row sm:flex-grow justify-between sm:w-auto w-full text-center">
